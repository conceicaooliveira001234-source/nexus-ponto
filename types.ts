...
export type ViewState = 'LANDING' | 'LOGIN_COMPANY' | 'REGISTER_COMPANY' | 'LOGIN_EMPLOYEE' | 'DASHBOARD_COMPANY' | 'DASHBOARD_EMPLOYEE' | 'FACIAL_ONBOARDING' | 'DASHBOARD_SUPER_ADMIN' | 'COMPANY_BLOCKED';
